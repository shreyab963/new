...
int main(int argc, char **argv)
{
    ...
    hostN = gethostname(client_name, MAX_MESSAGE_SIZE);
...
void addFile( HashTable* table, char* fileName, char* filePath) {
...
void printSearch(HashTable* table, char* fileName) {
    char* filePath;
    char temp[11];
    pid_t pid = getpid();
    sprintf(temp, "%d", pid);
    ...
    if ((fileName = search(table, fileName)) == NULL) {
